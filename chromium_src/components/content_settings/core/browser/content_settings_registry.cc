...
namespace {
  ...
  constexpr auto kSettingsNames = base::MakeFixedFlatMap<ContentSettingsType, const char*>({
  ...
  { BRAVE_WEBCOMPAT_EVENT_SOURCE_POOL, "brave-webcompat-event-source-pool"},
  { BRAVE_WEBCOMPAT_FONT, "brave-webcompat-font"},
  { BRAVE_WEBCOMPAT_HARDWARE_CONCURRENCY, "brave-webcompat-hardware-concurrency"},
  ...
  { BRAVE_WEBCOMPAT_USB_DEVICE_SERIAL_NUMBER, "brave-webcompat-usb-device-serial-number"},
