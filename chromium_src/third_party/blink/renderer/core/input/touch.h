...
#define screenX                                                               \
  screenX() const {                                                           \
    ...
    int delta_screenX = local_dom_window ?                                    \
      ...
      local_dom_window->screenX_ChromiumImpl(): 0;                            \
    int delta_outerWidth = local_dom_window ?                                 \
      local_dom_window->outerWidth() -                                        \
      local_dom_window->outerWidth_ChromiumImpl(): 0;                         \
    return std::floor(screenX_ChromiumImpl() +                                \
      delta_screenX + delta_outerWidth);                                      \
  }                                                                           \
...
#define screenY                                                               \
  screenY() const {                                                           \
    ...
    int delta_screenY = local_dom_window ?                                    \
      ...
      local_dom_window->screenY_ChromiumImpl(): 0;                            \
    int delta_outerHeight = local_dom_window ?                                \
      local_dom_window->outerHeight() -                                       \
      local_dom_window->outerHeight_ChromiumImpl(): 0;                        \
    return std::floor(screenY_ChromiumImpl() +                                \
      delta_screenY + delta_outerHeight);                                     \
  }                                                                           \
