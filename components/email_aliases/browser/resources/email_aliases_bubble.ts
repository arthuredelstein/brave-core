//import '@brave/leo/tokens/css/base.css'
...
//const rootElement = document.getElementsByTagName('h2')[0]
//console.log(new RemoteMappingService())
...
; (window as any).mountModal(root.shadowRoot, new MockMappingService())
