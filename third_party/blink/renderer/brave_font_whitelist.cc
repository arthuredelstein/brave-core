...
constexpr auto kFontWhitelistUbuntu2204Languages = base::MakeFixedFlatSet<std::string_view>({
  "ar pl ukai cn",
  "ar pl ukai hk",
  "ar pl ukai tw",
  "ar pl ukai tw mbe",
...
constexpr auto kFontWhitelistUbuntu2004 = base::MakeFixedFlatSet<std::string_view>({
  "aakar",
  "abyssinica sil",
  "ani",
  "anjalioldlipi",
...
constexpr auto kFontWhitelistUbuntu2004Languages = base::MakeFixedFlatSet<std::string_view>({
  "aharoni clm",
  "alarabiya",
  "albattar",
  "alhor",
...
constexpr auto kFontWhitelistFedora32 = base::MakeFixedFlatSet<std::string_view>({
  "abyssinica sil",
  "c059",
  "caladea",
  "cantarell",
