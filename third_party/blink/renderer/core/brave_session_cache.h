...
#ifndef BRAVE_THIRD_PARTY_BLINK_RENDERER_BRAVE_SESSION_CACHE_H_
#define BRAVE_THIRD_PARTY_BLINK_RENDERER_BRAVE_SESSION_CACHE_H_
...
CORE_EXPORT bool IsFarbling (ExecutionContext* context);
...
CORE_EXPORT int FarbledInteger(ExecutionContext* context, FarbleKey key,
  int spoofValue, int minRandomOffset, int maxRandomOffset, int defaultValue);
...
class CORE_EXPORT BraveSessionCache final
 ...
 public:
  ...
  int FarbledInteger(FarbleKey key, int spoofValue,
                     int minRandomOffset, int maxRandomOffset, int defaultValue);
 ...
 private:
  ...
  std::map<FarbleKey, int> farbledIntegers_;
...
#endif  // BRAVE_THIRD_PARTY_BLINK_RENDERER_BRAVE_SESSION_CACHE_H_
